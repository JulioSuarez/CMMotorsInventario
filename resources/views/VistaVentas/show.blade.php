...
@section('Contenido')
    ...
    <label  class="font-serif text-gray-800" for=""> Cliente: {{$venta->nombre_cliente}} {{$venta->apellido}}</label> <br>

    <div class="grid grid-cols-2">
        <label  class="font-serif text-gray-800" for=""> Empleado: {{$venta->nombre_empleado}} bs</label>
        <label  class="font-serif text-gray-800 text-right mr-8" for=""> Monto Total: {{$venta->monto_total}}</label>

    </div>

    <div class="my-4 mx-4 overflow-hidden rounded-lg shadow-xs"> <!-- reemplace w-full por mx-8 -->
