...
@section('Contenido')
    <div class="flex items-center text-center lg:text-left px-8 md:px-12 lg:w-1/2">
        <h2 class="text-3xl font-extrabold text-gray-100 md:text-4xl">
            REGISTRO DE COTIZACIONES </h2>
    </div>
    ...
    <div class="my-4 mx-4 overflow-hidden rounded-lg shadow-xs">
        ...
        <div class="w-full overflow-x-auto">
            <table class="w-full">
                <thead>
                    <tr
                        class="text-xs font-semibold tracking-wide text-left text-white uppercase border-b dark:border-gray-700 bg-gray-500  dark:bg-gray-800">
                        <th class="px-4 py-3">Nro_Venta</th>
                        <th class="px-4 py-3">Nombre Cliente </th>
                        <th class="px-4 py-3">Nombre Empleado </th>
                        {{-- <th class="px-4 py-3">Fecha y hora </th> --}}
                        <th class="px-4 py-3">Fecha Validez </th>
                        <th class="px-4 py-3">Fecha Realizadad </th>
                        <th class="px-4 py-3">Fecha y hora </th>
                ...
                <tbody class=" bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                    ...
                    @foreach ($cotizaciones as $v)
                        <tr
                            ...
                            <td class="px-4 py-3 text-xs">{{ $v->fecha_validez }}</td>

                            <td class="px-4 py-3 text-xs">{{ $v->fecha_realizada }}</td>
